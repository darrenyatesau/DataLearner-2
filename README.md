...
* distributed data-mining using multiple Android devices over a closed-network (experimental, NOTE: data transfer does NOT include any encryption, so we suggest you use generic, anonymised, low-value data only).
