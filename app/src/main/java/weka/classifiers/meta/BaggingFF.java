...
/**
 * <!-- globalinfo-start -->
 * Class for bagging a classifier to reduce variance. Can do classification and
 * regression depending on the base learner. <br/>
 * <br/>
 ...
 */
public class BaggingFF
        extends RandomizableParallelIteratedSingleClassifierEnhancer
        implements WeightedInstancesHandler, AdditionalMeasureProducer,
        TechnicalInformationHandler, PartitionGenerator, Aggregateable<BaggingFF> {
...
//-------------------------------------------------------------------------------
        m_Classifier = new weka.classifiers.trees.FastForestRT();
//-------------------------------------------------------------------------------
    }
    ...
    protected synchronized Instances getTrainingSet(int iteration) throws Exception {
        ...
        if (m_CalcOutOfBag) {
            ...
            return( new Instances(tempData, 0, (int)(0.4 * m_data.numInstances())) );
//------------------------------------------------------------------------------------------------------------                
//            }
        }
//        return(bagData);
             ...
             *
             * @return the out-of-bag evaluation object; null if out-of-bag
             * error hasn't been calculated
             */
    ...
    public String toString() {
        ...
        if (m_Classifiers == null) {
            return "BaggingPRF: No model built yet.";
        }
        StringBuffer text = new StringBuffer();
        text.append("BaggingPRF with " + getNumIterations() + " iterations and base learner\n\n" + getClassifierSpec());
        if (getPrintClassifiers()) {
    ...
    public static void main(String[] argv) {
        runClassifier(new BaggingFF(), argv);
    }
     ...
     */
    @Override
    public BaggingFF aggregate(BaggingFF toAggregate) throws Exception {
