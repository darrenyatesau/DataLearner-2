...
public class SysFor extends AbstractClassifier {
    ...
    private class GoodAttributesWithGainRatios implements Serializable {
        ...
        private final ArrayList<GoodAttributeWithGainRatio> elements;
    ...
    private class NumericSplitDistribution implements Serializable {
        ...
        private final Instances leftSideInstances;
        private final Instances rightSideInstances;
        private final int[] leftClassCount;
        private final int[] rightClassCount;
    ...
    private class SysForTree extends AbstractClassifier {
        ...
        private final ArrayList<J48> c45Trees = new ArrayList<J48>();
        private int numClasses = -1;
    ...
    private class SysForLevelTwoTree extends AbstractClassifier {
        ...
        private final GoodAttribute rootSplit;
