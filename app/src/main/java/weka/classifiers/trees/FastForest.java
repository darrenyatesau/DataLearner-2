...
import weka.classifiers.meta.BaggingFF;
 ...
 */
public class FastForest extends BaggingFF {
	...
	/**
	 * Constructor that sets base classifier for baggingPRF to SSR_RandomTree and default
	 * number of iterations to 100.
	 */
	public FastForest() {
		
		FastForestRT rTree = new FastForestRT();
	...
	public Capabilities getCapabilities() {
		...
		// Cannot use the main SSR_RandomTree object because capabilities checking has
		// been turned off
		// for that object.
		return (new FastForestRT()).getCapabilities();
	}
	...
	protected String defaultClassifierString() {
		...
		return "weka.classifiers.trees.FastForestRT";
	}
	...
	/**
	 * This method only accepts SSR_RandomTree arguments.
	 *
	 * @param newClassifier the SSR_RandomTree to use.
	 * @throws if argument is not a SSR_RandomTree
	 */
	@Override
	@ProgrammaticProperty
	public void setClassifier(Classifier newClassifier) {
		if (!(newClassifier instanceof FastForestRT)) {
			throw new IllegalArgumentException(
					"FastForest: Argument of setClassifier() must be a FastForestRT.");
		}
	...
	public void setRepresentCopiesUsingWeights(boolean representUsingWeights) {
		if (!representUsingWeights) {
			throw new IllegalArgumentException(
					"SSR_RandomForest: Argument of setRepresentCopiesUsingWeights() must be true.");
		}
	...
	public String numFeaturesTipText() {
		return ((FastForestRT) getClassifier()).KValueTipText();
	}
	...
	public int getNumFeatures() {
		...
		return ((FastForestRT) getClassifier()).getKValue();
	}
	...
	public void setNumFeatures(int newNumFeatures) {
		...
		((FastForestRT) getClassifier()).setKValue(newNumFeatures);
	}
	...
	public void setComputeAttributeImportance(boolean computeAttributeImportance) {
		...
		((FastForestRT) m_Classifier).setComputeImpurityDecreases(computeAttributeImportance);
	}
	...
	public String maxDepthTipText() {
		return ((FastForestRT) getClassifier()).maxDepthTipText();
	}
	...
	public int getMaxDepth() {
		return ((FastForestRT) getClassifier()).getMaxDepth();
	}
	...
	public void setMaxDepth(int value) {
		((FastForestRT) getClassifier()).setMaxDepth(value);
	}
	...
	public String breakTiesRandomlyTipText() {
		return ((FastForestRT) getClassifier()).breakTiesRandomlyTipText();
	}
	...
	public boolean getBreakTiesRandomly() {
		...
		return ((FastForestRT) getClassifier()).getBreakTiesRandomly();
	}
	...
	public void setBreakTiesRandomly(boolean newBreakTiesRandomly) {
		...
		((FastForestRT) getClassifier()).setBreakTiesRandomly(newBreakTiesRandomly);
	}
	...
	public void setDebug(boolean debug) {
		...
		((FastForestRT) getClassifier()).setDebug(debug);
	}
	...
	public void setNumDecimalPlaces(int num) {
		...
		((FastForestRT) getClassifier()).setNumDecimalPlaces(num);
	}
	...
	public void setBatchSize(String size) {
		...
		((FastForestRT) getClassifier()).setBatchSize(size);
	}
	...
	public void setSeed(int s) {
		...
		super.setSeed(s);
		((FastForestRT) getClassifier()).setSeed(s);
	}
	
	//-----------------------------------------------------------------------------------------------------
	public void setClassifiers(Classifier[] model) {
		try {
			m_Classifiers = AbstractClassifier.makeCopies(m_Classifier, m_NumIterations);
			for (int i = 0; i < m_Classifiers.length; i++) {
				m_Classifiers[i] = model[i];
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	//-----------------------------------------------------------------------------------------------------
	public Classifier getClassifier(int unit) {
		return m_Classifiers[unit];
	}
	//-----------------------------------------------------------------------------------------------------
	/**
	...
	public String toString() {
		...
		if (m_Classifiers == null) {
			return "SSR_RandomForest: No model built yet.";
		}
		StringBuilder buffer = new StringBuilder("SSR_RandomForest\n\n");
	...
	public double[] computeAverageImpurityDecreasePerAttribute(
		...
		for (Classifier c : m_Classifiers) {
			double[][] forClassifier = ((FastForestRT) c).getImpurityDecreases();
	...
	public void setOptions(String[] options) throws Exception {
		...
		//------------------------------------------------------------------------------------------------
		FastForestRT classifier = new FastForestRT();
		classifier.setOptions(options);
//      ((FastForestRT) AbstractClassifier.forName(defaultClassifierString(),
//        options));
		//------------------------------------------------------------------------------------------------
